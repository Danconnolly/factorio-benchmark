...
def run_smelt_callback_session(*, runtime: SmeltSessionRuntime, model_id: str,
                               callback: AgentCallback) -> dict[str, Any]:
    """Provision benchmark lifecycle and invoke a credential-free callback."""
    args = argparse.Namespace(
        ...
        runs_dir=runtime.runs_dir, run_name=runtime.run_name, model_id=model_id,
